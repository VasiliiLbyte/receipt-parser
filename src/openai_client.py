...
2. **Дата**: приведи к формату ГГГГ-ММ-ДД. На российских чеках дата обычно в формате ДД.ММ.ГГ (например, 15.10.24 означает 15 октября 2024 года → "2024-10-15"). Двузначный год 24 = 2024, 25 = 2025 и т.д.
